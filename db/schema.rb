...
ActiveRecord::Schema.define(version: 2024_04_10_001959) do
  ...
  create_table "admin_tags", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.string "name"
  ...
  create_table "dashboard_admin_tags", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
